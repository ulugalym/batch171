...
public class HashMap03 {
    public static void main(String[] args) {
        ...
        //words arrayindeki kelimeleri birer birer Map de varmi yokmu diye kontrol edecegiz
        //words arrayindeki kelimeler Map de yoksa Mape value su 1 olarak yerlestirilecek
        ...
        String hl="Hello Henry!";
        hl=hl.replaceAll("[^A-Za-z]","");
        System.out.println(hl);
        String letter[]=hl.split("");
        System.out.println(Arrays.toString(letter));
        HashMap<String,Integer>hs=new HashMap<>();
        for(String w:letter){
            Integer harfSayac=hs.get(w);
            if(harfSayac==null){
                hs.put(w,1);
            }else{
                hs.replace(w,harfSayac+1);
            }
        }
