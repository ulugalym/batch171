...
public class HashMap01 {
    public static void main(String[] args) {
       ...
       int usaPopulation= countryPopulation.get("USA");
        ...
        //Ornek1: countryPopulation map indeki ulkelerin nufuslarinin ortalamasi kactir?
        ...
        //Ornek2: countryPopulation Mapindeki ulkelerin isimlerinin character sayisi ile nufuslarinin toplamini bulunuz
        int toplam=0;
