...
public class Switch03 {
    public static void main(String[] args) {
        ...
        System.out.println("Luffan iki sayi giriniz");
        double a=input.nextDouble();
        double b=input.nextDouble();
        System.out.println("Yapilacak islemi giriniz.+,-, *, /, % dan birisini giriniz");
        ...
        switch(opr){
            ...
            case'%':
                ...
                break;
            default:
                System.out.println("Bu islem tanimlanmamisdir...");
        }
    }
}
