...
public class Exception05 {
    public static void main(String[] args) {
        ...
        try {
            fis = new FileInputStream("src/main/java/day32exceptions/file.txt");
            int k = 0;
            while ((k = fis.read()) != -1) {
        ...
        /*
        1)FileNotFoundException ve IOException Compile Time Exceptionlardir, yani code yazarkan hata aliriz.
