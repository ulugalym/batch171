...
public class Exception01 {
    ...
    Java Exception firlattiginda kodun calismasini durdurur(Stops exception)
    Java Exception olusturan kod icin bizden karar vermemizi ister

    Eger hic bir sey yapmazsak beklandigi gibi Java kodumuzun calismasini durdurur.
        -Kodumuzun calismaya devam etmegini istiyorsak try catch ile exception olusturmasi multemel kodlarimizi
        try catch blodu icine yazmaliyiz

         -Exception i halledebilmek icin iki temel yol vardir
           1)Exception a uygun cozumler uretebilirsiniz . Buna Exception Hanling denir
           2)Exception olustugunda bunu ilan eder ve geri cekilirsiniz. Bunmda throw exception denir.

         -Exception a uygun cozumler uretmede try-catch kullanilir
         try blok da yapilmasi gereken islemler javada istenir
         Java islemi problemsiz bir sekilde yaparsa catch block java java tarafindan okunmaz
    ...
    //If=else kesinlekle tavsiye edilmez!
