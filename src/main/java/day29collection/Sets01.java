...
public class Sets01 {
    public static void main(String[] args) {
        ...
        2) 3 tane Set class vardir
            a) HashSet Class:
               "Hash" benzersiz bir id olusturma teknigidir. Bu tekniga "Hashing Technique" denir
            ...
            c) TreeSet Class:
               TreeSet ler elemanlari natural order (kucukden buyuge yada alfabetik sira) a gore dizerler
        ...
        System.out.println(ts.lower('F'));//E ==> Verilen eleman olan F olmadigi icin olsaydi nerede olurduyu bulup bir oncekini elemani verir.
