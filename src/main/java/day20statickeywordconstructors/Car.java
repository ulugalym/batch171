...
public class Car {
    ...
    gozle gorulmeyan otamatic olarak java tarafindan verilen bu constructorlara default constructor denir
     ...
     1)Construktor nasil olusturulur?
     ...
     2)Method ile constructor arasindaki farklar nelerdir?
        ...
        c) Method lar bir aksiyon yapmak icin olusturulurlar
     ...
     3)Parametreli Constructor olusturarak ayni class dan farkli ozelliklere sahip objectler olusturabiliriz
     */
    String make="Honda";
    String model="Accord";
    int year=2023;
