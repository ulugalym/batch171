    ...
    public static void main(String[] args) {
        ...
        5)Iki tip iterator vardir:
          a)Iterator:Bu sadece eleman silmede kullanilir.
                     Eleman eklemek veya elemani degisatirmek mumkun degildir
        ...
        while(yourListItr.hasNext()){
            ...
            yourListItr.set(el+"*");//set() methodu liste update etmeye yarar
        }
        System.out.println(yourList);
        ...
        //pointeri yukardaki kod ile ensonda biraktigimiz icin
